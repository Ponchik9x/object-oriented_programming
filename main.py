from src.basic_classes import BaseProduct
...
class Smartphone(Product):
    ...
    # def add_product(self, value):
    #     if isinstance(value, Smartphone):
    #         super().add_product(value)
